...
(function(document) {
  ...
  window.addEventListener('WebComponentsReady', function() {
    ...
    .then(function(response){addSearchHeader(response.query); return getJSON(response.results[0]);})
    .catch(function() {throw error('Search Error');})
    .then(function(planetinfo){createPlanetThumb(planetinfo);})
